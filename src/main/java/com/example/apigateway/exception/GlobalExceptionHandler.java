...
@Component
@Order(-2) // make sure this class acts as a default error handler since the reactive system behaves differently
public class GlobalExceptionHandler implements ErrorWebExceptionHandler {
    ...
    public Mono<Void> handle(ServerWebExchange exchange, Throwable ex) {
        // if the error already sent to client, we don't need to do anything
